...
public class AdminMealRestController extends AbstractMealController{
    ...
    public ResponseEntity<Meal> createWithLocation(@Valid @RequestBody Meal meal, @RequestParam("menuId") int menuId) {
    ...
    public void update(@PathVariable("id") int id, @Valid @RequestBody Meal meal, @RequestParam("menuId") int menuId) {
